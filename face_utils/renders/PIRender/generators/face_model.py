...
from ..utils import warp_image as warp_image_func, convert_flow_to_deformation
from .base_function import LayerNorm2d, ADAINHourglass, FineEncoder, FineDecoder

class FaceGenerator(nn.Module):
    def __init__(
        self, 
        mapping_net={'coeff_nc': 73, 'descriptor_nc': 256, 'layer': 3},
        warpping_net={'encoder_layer': 5, 'decoder_layer': 3, 'base_nc': 32}, 
        editing_net={'layer': 3, 'num_res_blocks': 2, 'base_nc': 64}, 
        common={'image_nc': 3, 'descriptor_nc': 256, 'max_nc': 256, 'use_spect': False},
        ):  
...
class WarpingNet(nn.Module):
    ...
    def forward(self, input_image, descriptor):
        ...
        final_output['warp_image'] = warp_image_func(input_image, deformation)
        return final_output
